...
>
> On the right, the previous **children’s area** at the top has been replaced by a **lecture room**. The large **enquiry desk** near the entrance has been **reconfigured** as a smaller **information desk** set **further inside**, with a row of **self-service machines** above a new **café** occupying the **bottom-right** corner. In the middle, **adult non-fiction** has given way to **adult fiction**, while **all reference books** are now **shelved on** the left side.
