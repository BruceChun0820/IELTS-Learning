...
<img src="/Users/qinhao/Code/MdWorkSpace/IELTS Learning/Writing Task/Writing Task1/img/16_Test4_Task1.png" style="zoom: 33%;" />

## My Writing

> The flow graph illustrates the process by **which** plastic bottles are recycled and **transformed into new products**, which are later **introduced to the market**.
...
> In the first stage, people place used bottles into recycling bins, which are then collected by garbage trucks. The bottles ==are transported to== a recycling center, where they are sorted and compressed into blocks. These blocks are subsequently crushed and washed to prepare for ==further processing==.

> Next, the crushed plastic is melted into pellets, which are heated again to form raw materials. These are delivered to factories to produce commodities like bottles, bags, and clothing. Finally, these goods re-enter the consumer market and can be recycled again, ==completing the cycle==.