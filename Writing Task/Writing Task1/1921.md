...
The two maps compare the current layout of a harbour and in 2000.

**The two maps compare Proth Harbour in 2000 with its current layout.**

Overall, the harbour~~'s function~~ has been ~~converted into~~ **transformed to focus more on** commerce and tourism, with addition of retail **facilities**, **a** hotel, and an expanded dock, while the main road and lifeboat remain unchanged.

In the ~~west part~~ **western part**, a new **block of** showers and toilets ~~plot~~ has been added between two car parks, while the entrance of the ~~south~~ southern parking lot has been ~~oriented~~ **reoriented** to connect **with** **the** main road. In addition, the marina for private yachts and the other for fishing boats ~~exchanged their place~~ **swapped locations**. ~~Beside~~ Next to the lifeboat, there are a row of new retails **units**, **including** ~~involving~~ cafes and shops.

For the ~~east part~~ **eastern** part, **the** original disused castle ~~locating at~~ **located in** the southeast corner has been converted into a hotel, with a new road constructed to connect it ~~and~~ **to** main road. ~~and~~ The **nearby** public beach ~~near it~~ has **also been** ~~turned~~ **converted** into **a** private **beach** for guests, while the northern public beach remains unchanged. Meanwhile, **the** dock in the bay has been ~~enlarged~~ expanded from poccessing only one **pier** to two ~~piers~~, ~~which can~~ **allowing it** serves more passenger ferries.